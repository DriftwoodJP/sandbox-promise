...
function getUserInfo(userId) {
  if (!(typeof userId === "string")) {
    console.assert(typeof userId === "string", 'Expected type: @param {String} userId\nActual value:', userId, '\nFailure assertion: typeof userId === "string"');
  }
...
function createView(userInfo) {
  if (!((typeof userInfo === 'undefined' ? 'undefined' : _typeof(userInfo)) === "object")) {
    console.assert((typeof userInfo === 'undefined' ? 'undefined' : _typeof(userInfo)) === "object", 'Expected type: @param {Object} userInfo\nActual value:', userInfo, '\nFailure assertion: typeof userInfo === "object"');
  }
...
function displayView(view) {
  if (!(typeof view === "string")) {
    console.assert(typeof view === "string", 'Expected type: @param {String} view\nActual value:', view, '\nFailure assertion: typeof view === "string"');
  }
...
function escapeSpecialChars(str) {
  if (!(typeof str === "string")) {
    console.assert(typeof str === "string", 'Expected type: @param {String} str\nActual value:', str, '\nFailure assertion: typeof str === "string"');
  }
...
function escapeHTML(strings) {
  ...
  if (!(typeof Symbol === "function" && _typeof(Symbol.hasInstance) === "symbol" && typeof Strings !== "undefined" && typeof Strings[Symbol.hasInstance] === "function" ? Strings[Symbol.hasInstance](strings) : typeof Strings === "undefined" || typeof Strings !== "function" || strings instanceof Strings)) {
    console.assert(typeof Symbol === "function" && _typeof(Symbol.hasInstance) === "symbol" && typeof Strings !== "undefined" && typeof Strings[Symbol.hasInstance] === "function" ? Strings[Symbol.hasInstance](strings) : typeof Strings === "undefined" || typeof Strings !== "function" || strings instanceof Strings, 'Expected type: @param {Strings} strings\nActual value:', strings, '\nFailure assertion: (typeof Symbol === "function" && typeof Symbol.hasInstance === "symbol" && typeof Strings !== "undefined" && typeof Strings[Symbol.hasInstance] === "function" ?Strings[Symbol.hasInstance](strings) :typeof Strings === "undefined" || typeof Strings !== "function" || strings instanceof Strings)');
  }

  return strings.map(function (part, i) {
    var value = values[i];
    if (value) {
